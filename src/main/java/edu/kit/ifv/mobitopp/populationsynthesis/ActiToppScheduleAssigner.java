...
import edu.kit.ifv.mobitopp.actitopp.AttributeLookup;
import edu.kit.ifv.mobitopp.actitopp.CSVExportLogger;
import edu.kit.ifv.mobitopp.actitopp.Configuration;
import edu.kit.ifv.mobitopp.actitopp.DCDefaultModelStep;
...
/**
 * 
 * Class to assign activity schedules using actitopp model
 * 
 * @author Tim Hilgert
 *
 */
public class ActiToppScheduleAssigner implements ActivityScheduleAssigner
{
  ...
  public ActiToppScheduleAssigner(long seed, PanelDataRepository repository, File resultfolder, File basePath)
  {
    ...
    try 
    {
			this.logger = new CSVExportLogger(resultfolder);
		} 
    catch (IOException e) {
			e.printStackTrace();
		}
    ...
    fileBase_detailedPurposes = new ModelFileBase(basePath, dcsteps_purposes, null, null);
